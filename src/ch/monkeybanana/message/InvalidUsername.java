...
public class InvalidUsername extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InvalidUsername frame = new InvalidUsername();
	...
	public InvalidUsername() {
		...
		JLabel lblPasswordMussAusgefllt = new JLabel("username ist bereits vergeben");
		...
		lblNewLabel.setIcon(new ImageIcon(InvalidUsername.class.getResource("/images/cancel.png")));
