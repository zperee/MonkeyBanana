...
public class RegistrSuccess extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistrSuccess frame = new RegistrSuccess();
	...
	public RegistrSuccess() {
		...
		JLabel lblPasswordMussAusgefllt = new JLabel("Sie wurden erfolgreich registriert");
		...
		lblNewLabel.setIcon(new ImageIcon(RegistrSuccess.class.getResource("/images/add.png")));
