...
public class UsernameEmpty extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UsernameEmpty frame = new UsernameEmpty();
	...
	public UsernameEmpty() {
		...
		JLabel lblPasswordMussAusgefllt = new JLabel("Username muss ausgef\u00FCllt sein");
		...
		lblNewLabel.setIcon(new ImageIcon(UsernameEmpty.class.getResource("/images/cancel.png")));
