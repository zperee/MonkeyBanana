...
public class PasswordError extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PasswordError frame = new PasswordError();
	...
	public PasswordError() {
		...
		JLabel lblPasswordMussAusgefllt = new JLabel("Passw\u00f6rter stimmen nich \u00FCberein");
		...
		lblNewLabel.setIcon(new ImageIcon(PasswordError.class.getResource("/images/cancel.png")));
