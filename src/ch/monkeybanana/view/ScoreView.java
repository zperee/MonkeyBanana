...
import ch.monkeybanana.model.User;
	...
	public class ScoreView extends JFrame {
		...
		public ScoreView(User user, int score1, int score2, String user1, String user2, boolean winner, boolean isForfait) {
			...
			this.setIconImage(Toolkit.getDefaultToolkit().getImage(ScoreView.class.getResource("/images/banana.png")));
			...
			JLabel lblNewLabel_2 = new JLabel(new ImageIcon(ScoreView.class.getResource("/images/monkeyRed.png")));
			...
			JLabel label_3 = new JLabel(new ImageIcon(ScoreView.class.getResource("/images/monkeyBlue.png")));
